...
class Trainer():
	def __init__(self):
		...
		self.model = get_unet_attention(pretrained_weights='./snapshot/scnn_curbstonedata_best_model_CEloss.pth')
	...
	def save_checkpoint(self,is_best=False):
		...
		filename = '{}_{}.pth'.format('unetattention', 'curbstonedata')
		save_path = os.path.join(directory, filename)
		torch.save(self.model.state_dict(), save_path)
		if is_best:
			best_filename = '{}_{}_best_model.pth'.format('unetattention', 'curbstonedata')
